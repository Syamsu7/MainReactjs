...
const Text3 = () => {
    return(
        <div className='text-box2'>
            <p>I am really highly asking you mates to practice a lot to be able to obtain your own desires, as my experience
                that I had never thought to be able to be a web developer currently, yet I had the strong wishing, I am convinced
